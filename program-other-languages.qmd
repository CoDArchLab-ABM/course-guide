...
Consider yourself introduced to NetLogo! However, remember that ABM isn't limited to this language and platform. We highly recommend learning and practising with other programming languages to see how ABM models can be implemented in different ways, with different goals and trade-offs.

## ABM beyond NetLogo

In theory, you can use any programming language to implement an ABM model. After all, an ABM is “just code” describing the state and behaviour of multiple interacting agents over time. However, ABM modellers typically rely on specialised **frameworks** or **libraries** that provide ready-made functions for creating agents, scheduling their actions, managing environments, and recording outputs.
...
Below are some of the most relevant ABM platforms and libraries beyond NetLogo. Each offers different strengths and targets different audiences.
...
Many more ABM frameworks exist across different domains and programming languages.
