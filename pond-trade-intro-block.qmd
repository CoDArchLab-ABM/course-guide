...
- If your version becomes too chaotic or has too many small variations, use the reference files as a starting point for the next implementation step (e.g., use "BlockA_PondTrade_step05_refactoring and organising code.nlogox", referenced at the end of chapter 16, to start the work on chapter 17).  
