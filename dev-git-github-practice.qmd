...
This chapter puts into practice the workflow introduced earlier (Chapter @dev-git-github). You will now create a proper, version-controlled home for your simulation model. Your repository will serve as a **living record** of your project’s evolution — from conceptualisation and first prototype to final publication.
