...
Run the model for a few years using the default configuration. Observe the behaviour of traders and the overall dynamics of settlements' economical size and the trade between them. Is there something off about how the new version is running? 
