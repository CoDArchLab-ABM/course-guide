# Integrating complex submodels {#messara-integrations}
...
to paint-routes
  ...
  ;;; NOTE: this is needed because RGB colours based on elevation are a list
  ...
  [ ?1 ->
    ...
    [ ??1 ->
      ...
      [
        if (showRoutes)
        [
          ifelse (not member? pcolor redShades) ; if it's the first route crossing the patch
          [
            set pcolor 11
          ]
          [
...
## ARID as a factor of settlement productivity
...
to update-settlements
  ...
  [
    ...
    ; production is generated in proportion to sizeLevel, following a constant rate and the average ARID within the settlement catchment area
...
## Checking the milestone File (module 6)
