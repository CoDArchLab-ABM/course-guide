...
Sometimes existing alternative designs, or "competing" versions of the model, are worth exploring. For this, we can use the mediation of nominal parameters, which in NetLogo would typically reside in the interface as switches and chooser widgets. This is not available in the Artificial Anasazi, but the `simulation-period` chooser in the Mesara Trade could be considered this way.
...
Before sampling, define parameter ranges carefully.
...
Once you define parameter ranges, R can generate a **design of experiments** that you can pass to NetLogo.
...
Define plausible ranges for two model parameters.
