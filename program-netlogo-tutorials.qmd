...
In this chapter you will be guided toward a solid foundation in NetLogo by working through the four official tutorials provided by the NetLogo developers. These tutorials are not optional extras but rather the *core learning path* into the modelling environment we will use throughout this course. They introduce the interface, the language, and the modelling mindset you will need for your simulation work.
