...
**Parameter**: it does not vary with time, but it can vary between instances of the phenomenon (&approx;simulation runs). It is considered as an input of the phenomenon (&approx;model).
